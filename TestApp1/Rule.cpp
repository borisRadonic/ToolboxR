...
void Rule::setCoefficientsC(const std::vector<std::double_t>& ccoeffs, std::double_t c0)
{
	_ccoeffs = ccoeffs;
	_offsetC0 = c0;
}

std::double_t Rule::getCoefficient(const std::uint32_t i)
{
	...
	{
		throw new std::exception("Coeff. is out of range!");
	}
	return 0.0;
}
